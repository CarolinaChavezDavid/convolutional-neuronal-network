...
MobileNetV2 es una arquitectura de red neuronal convolucional diseñada para ser eficiente en términos de recursos computacionales, lo
que la hace adecuada para su implementación en dispositivos móviles. Su diseño se basa en bloques convolucionales livianos que reducen
la cantidad de operaciones necesarias durante la inferencia, manteniendo un buen desempeño en tareas de clasificación de imágenes.

En esta investigación, MobileNetV2 se utilizó como modelo base para el entrenamiento inicial debido a su amplia adopción en aplicaciones
móviles y a su buen balance entre precisión y eficiencia computacional. A partir de este punto, se exploraron versiones alternativas de
la familia MobileNet, especialmente MobileNetV3 y MobileNetV5, con el propósito de identificar si arquitecturas más recientes podían
mejorar el rendimiento del sistema sin afectar de forma significativa su viabilidad en el dispositivo móvil.

\subsection{EfficientNet}
EfficientNet es una familia de arquitecturas de red neuronal convolucional que busca lograr un equilibrio entre precisión y eficiencia
computacional. A diferencia de otras arquitecturas que aumentan principalmente la profundidad o el ancho de la red, EfficientNet utiliza
una estrategia de escalado más sistemática, ajustando de manera conjunta la profundidad, el ancho y la resolución de entrada.

En el marco de esta metodología, EfficientNet se incorporó como una alternativa de comparación frente a los modelos de la familia
MobileNet. Su inclusión permite evaluar si un modelo con mayor capacidad de representación puede mejorar la clasificación de enfermedades
en hojas, y al mismo tiempo permite analizar el costo asociado en términos de tamaño del modelo, tiempo de inferencia y desempeño en el
dispositivo móvil utilizado para las pruebas.
